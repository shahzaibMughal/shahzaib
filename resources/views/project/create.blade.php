...
@section('content')
    ...
    <form action="{{route('admin.project.store')}}" method="post" enctype="multipart/form-data">
        ...
        <input type="text"  value="{{old('title')}}" name="title" placeholder="Project Title">
        <p class="error">{{$errors->first('description')}}</p>
        <input type="text"  value="{{old('description')}}" name="description" placeholder="Project Description">
        <p class="error">{{$errors->first('liveLink')}}</p>
        <input type="text"  value="{{old('liveLink')}}" name="liveLink" placeholder="Live link">
        <p class="error">{{$errors->first('githubLink')}}</p>
        <input type="text"  value="{{old('githubLink')}}" name="githubLink" placeholder="Github link">
